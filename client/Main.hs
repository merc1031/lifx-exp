...
checkSanity
  ...
  let
    decd
      :: Either _ (_,_, Header)
    decd
      = Bin.decodeOrFail ")\NUL\NUL\DC4\210\EOT\NUL\NUL\208s\213%Y\SYN\NUL\NULLIFXV2\SOH\NUL\NUL\241\222i-\238\EOT\NUL\ETX\NUL\NUL\NUL\SOH|\221\NUL\NUL"
  print $ show decd
...
main
  ...
  let
    Just theaterLamp
      = L.find
      (\l ->  lLabel l == Just (Label "Theater Lamp"))
      cached
...
--  sendToLight (asSharedState r) theaterLamp (unkP $ GetUnknown54)
  ...
  sendToLight
    (asSharedState r)
    theaterLamp
    (ap $ SetLightPower (LightPower 65535) 1000)
  ...
  let
    ...
    loope !n
      ...
      let
        Just firstColor
          = HSBK <$> hue 128.85 <*> saturation 35.8 <*> brightness 100 <*> kelvin 2500
        Just smearColor
          = HSBK <$> hue 79 <*> saturation 100 <*> brightness 100 <*> kelvin 2500
        Just secondColor
          = HSBK <$> hue 0.132 <*> saturation 100 <*> brightness 100 <*> kelvin 2500
        firstTransition
          = 5000
        secondTransition
          = 5000
